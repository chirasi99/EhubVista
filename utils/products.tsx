export const products = [
        ...
        {
          id: "649d775128b6744f0f497080", // Replace with a unique ID for your MacBook product
          name: 'MacBook Pro 13-inch (M2, 2023)',
          description:
            'The latest MacBook Pro featuring the powerful M2 chip, stunning Retina display, and exceptional performance for all your creative tasks.',
          price: 5499, // Update the price accordingly
          brand: "Apple", // Change the brand to "Apple"
          category: "Laptop", // Change the category to "Laptop"
          inStock: true,
          images: [
            {
              color: "Silver", // Update the color
              colorCode: "#C0C0C0", // Update the color code
              image:
                "https://images.pexels.com/photos/812264/pexels-photo-812264.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", // Update the image URL
            },
            {
              color: "Black", // Update the color
              colorCode: "#252525", // Update the color code
              image:
                "https://images.pexels.com/photos/2148216/pexels-photo-2148216.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", // Update the image URL
            },
          ],
          reviews: [],
        }
